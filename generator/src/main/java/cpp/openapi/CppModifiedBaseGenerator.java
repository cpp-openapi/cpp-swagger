...
// this is copied from abstractCppCodegen, because it crashes. Will submit fix to upstream once this is fixed here.
...
abstract public class CppModifiedBaseGenerator extends DefaultCodegen implements CodegenConfig {
    private final Logger LOGGER = LoggerFactory.getLogger(CppModifiedBaseGenerator.class);
    ...
    public CppModifiedBaseGenerator() {
        super();
    ...
    public CodegenProperty fromProperty(String name, Schema p) {
        ...
        if(property == null)
        {
            // sometimes the base cannot process property
            return null;
        }
