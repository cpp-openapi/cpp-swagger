 ...
 * 1) Set a break point in CppOpenapiGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class CppOpenapiGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("cpp-openapi") // use this codegen library
              ...
              .setOutputDir("out/cpp-openapi"); // output directory
